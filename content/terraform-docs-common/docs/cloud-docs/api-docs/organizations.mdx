...
This endpoint shows organizations that are configured to share modules with an organization through [Module Sharing](/terraform/enterprise/application-administration/registry-sharing).
