...
## Adjusting Polling Schedule Intervals
...
To modify these intervals, navigate to **All > Flow Designer > Flows** in ServiceNow. You may modify this frequency by changing
