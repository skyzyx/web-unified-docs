...
last_modified: 2026-02-16T19:52:42.000Z
# END AUTO GENERATED METADATA
---

# Prepare the Terraform Enterprise host environment

This topic describes how to prepare a Linux instance on your cloud provider to host a Terraform Enterprise deployment.
